...
extension WorkBench {
    ...
    func get7Days(with dateInfo: Date, is lastDays: Bool) -> [DingTalkCalanderModel] {
        ...
        for eachItem in 1 ... 7 {
            ...
            if day.days == curentDayIndex.days &&
                day.year == curentDayIndex.year &&
                day.month == curentDayIndex.month {
                dingIns.setParameters(gregorionDay: day.days,
                                      weekDay: day.weekday,
                                      lunarDay: 3,
                                      isCurrentDay: true,
                                      isFirstDayCurrentMonty: isCurrentMonthFirstDay,
                                      dateInfo: day, isCurrentMonthDay: true)
            } else {
                dingIns.setParameters(gregorionDay: day.days,
                                      weekDay: day.weekday,
                                      lunarDay: 3,
